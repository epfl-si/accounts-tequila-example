  ...
  render() {
    return (
      <div className="main">
        ...
        <ul>
          <li>Please check the <a href="/doc/README.md">README.md</a> of the project.</li>
          <li>EPFL Tequila attributes are listed <a href="/doc/TEQUILA_ATTRIBUTES.md">here</a>.</li>
          <li>You can try to login <a href="/private">here</a>.</li>
        </ul>
        <hr />
